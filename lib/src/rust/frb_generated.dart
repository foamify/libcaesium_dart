...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1656997355;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'libcaesium_dart',
  ...
  Future<void> crateApiSimpleCompress(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_u_8(pngOptimizationLevel, serializer);
        sse_encode_bool(keepMetadata, serializer);
        sse_encode_bool(optimize, serializer);
        sse_encode_opt_box_autoadd_usize(maxOutputSize, serializer);
