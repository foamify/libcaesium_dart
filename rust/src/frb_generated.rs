...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1656997355;
...
fn wire__crate__api__simple__compress_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_png_optimization_level = <u8>::sse_decode(&mut deserializer);
            let api_keep_metadata = <bool>::sse_decode(&mut deserializer);
            let api_optimize = <bool>::sse_decode(&mut deserializer);
            let api_max_output_size = <Option<usize>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
